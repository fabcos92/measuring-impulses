...
class SignalChart(DataVariables):
    ...
    def save(self, name):
        ...
        self.name = name
        with open("S:\Doktorat\Python\Dane\Codes\{}.txt".format(name), 'w') as Peak:
...
plt.subplot(212)
SignalChart(data.data[0,], plot_label='Channel 1', line_color='r').save(name="BxHPF")
SignalChart(data.data[1,], plot_label='Channel 3', line_color='b').save(name="ByHPF")
plt.grid()
plt.show()
